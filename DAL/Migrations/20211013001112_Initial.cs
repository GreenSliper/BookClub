        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RememberQuality = table.Column<int>(type: "integer", nullable: true),
                    Rating = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadBook", x => new { x.ReaderID, x.BookID });
                    table.ForeignKey(
                        name: "FK_ReadBook_AspNetUsers_ReaderID",
                        column: x => x.ReaderID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReadBook_Books_BookID",
                        column: x => x.BookID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubBook", x => new { x.ClubID, x.BookID });
                    table.ForeignKey(
                        name: "FK_ClubBook_AspNetUsers_AddedByUserId",
                        column: x => x.AddedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClubBook_Books_BookID",
                        column: x => x.BookID,
                        principalTable: "Books",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClubBook_Clubs_ClubID",
                        column: x => x.ClubID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubsMembers", x => new { x.ClubID, x.UserID });
                    table.ForeignKey(
                        name: "FK_ClubsMembers_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClubBook_AddedByUserId",
                table: "ClubBook",
                column: "AddedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ClubBook_BookID",
                table: "ClubBook",
                column: "BookID");
